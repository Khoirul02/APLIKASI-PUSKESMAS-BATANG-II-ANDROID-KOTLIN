...
import kotlinx.android.synthetic.main.fragment_antrian_hari_ini.*
...
class AntrianHariIniFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_antrian_hari_ini, container, false)
    }
    ...
    private fun getDataAntrianHariIni(id_pasien : String) {
        RetrofitClient.instance.getAntrianByIdPasien(id_pasien,"get_antrian_id_pasien_and_date")
